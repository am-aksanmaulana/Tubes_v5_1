...
public class OrderListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        refresh();
        adapterOrderList = new AdapterOrderList(getActivity(), orderListList, "orderListFragment");
    ...
    public void refresh() {
        ...
        Call<ApiData<List<OrderList>>> call = apiService.getOrderListByIdBusinessWithJoin(idBusiness);
